...
function draw() {
    ...
    melon.image(dithered, width / 4, height / 4, width * dist, height * dist);

    pine.image(dithered, width * .75, height / 4, width * dist, height * dist);

    bubblegum.image(dithered, width * 0.75, height * 0.75, width * dist, height * dist);

    red.image(dithered, width / 4, height * 0.75, width * dist, height * dist);
